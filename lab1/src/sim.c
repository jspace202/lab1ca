...
int b_process(char* i_) {
  ...
  imm[0] = i_[31-31]; //imm12
  imm[1] = i_[31-7];  //imm11
  imm[2] = i_[31-30]; //imm10
  imm[3] = i_[31-29];
  imm[4] = i_[31-28]; 
  imm[5] = i_[31-27]; 
  imm[6] = i_[31-26];
...
int s_process(char* i_) {
  ...
  // Old-fashioned method but works :)
  imm[0] = i_[31-31]; //imm11
  imm[1] = i_[31-30];  //imm10
  imm[2] = i_[31-29]; //imm9
  imm[3] = i_[31-28];
  imm[4] = i_[31-27]; 
  imm[5] = i_[31-26]; 
...
char d_opcode[8];
  ...
  imm[8] = i_[31-23]; //imm3
  imm[9] = i_[31-22];
  imm[10] = i_[31-21]; //imm1
  imm[11] = i_[31-20]; //imm11
  imm[12] = i_[31-19]; //imm19
  imm[13] = i_[31-18];  //imm18
  imm[14] = i_[31-17]; //imm17
  imm[15] = i_[31-16];
  imm[16] = i_[31-15]; 
  imm[17] = i_[31-14]; 
  imm[18] = i_[31-13];
  imm[19] = i_[31-12]; //imm12
  imm[20] = '\0';  
...
char d_opcode[8];
  ...
  // Old-fashioned method but works :)
  imm[0] = i_[31-31]; //imm31
  imm[1] = i_[31-30];  //imm30
  imm[2] = i_[31-29]; //imm29
  imm[3] = i_[31-28];
  imm[4] = i_[31-27]; 
  imm[5] = i_[31-26]; 
  imm[6] = i_[31-25];
  imm[7] = i_[31-24]; //imm24
  imm[8] = i_[31-23]; //imm23
  imm[9] = i_[31-22];
  imm[10] = i_[31-21];
  imm[11] = i_[31-20]; //imm20
  imm[12] = i_[31-19]; //imm19
  imm[13] = i_[31-18];  //imm18
  imm[14] = i_[31-17]; //imm17
  imm[15] = i_[31-16];
